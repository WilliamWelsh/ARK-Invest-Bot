...
namespace ARK_Invest_Bot
{
    public static class StringUtils
    {
        ...
        // Cut stuff before in a string
        public static string CutBeforeLast(this string source, string target) =>
            source.Substring(source.LastIndexOf(target, StringComparison.Ordinal) + target.Length);
        ...
        // Cut stuff after in a string
        public static string CutAfterLast(this string source, string target) =>
            source.Substring(0, source.LastIndexOf(target, StringComparison.Ordinal));
